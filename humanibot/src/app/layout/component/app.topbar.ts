...
@Component({
    selector: 'app-topbar',
    standalone: true,
    imports: [RouterModule, CommonModule, StyleClassModule, AppConfigurator, Menu, ButtonModule, Tooltip],
        ...
        <div class="layout-topbar-actions">
            ...
            <div class="layout-topbar-menu hidden lg:block">
                <div class="layout-topbar-menu-content">
                    ...
                    <div class="max-lg:pointer-events-none">
                        <p-menu #menu [model]="configuracion" [popup]="true" />
                        <button (click)="menu.toggle($event)" type="button" class="layout-topbar-action" >
                            <i class="pi pi-user"></i>
                            <span>Perfil</span>
                        </button>
                    </div>
                      <button pTooltip="Salir" tooltipPosition="bottom" (click)="cerrarSesion()" type="button"
